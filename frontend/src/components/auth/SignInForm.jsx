    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result.token && result.role) {
          // Store user data and token using context function
          login({ role: result.role, ...result.user }, result.token);




          // Redirect based on role
          if (result.role === "Site Engineer") {
            navigate("/SiteEngineerDashboard");
          } else if (result.role === "Safety Engineer") {
