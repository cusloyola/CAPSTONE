// ViewIncidentReportAdmin.jsx
import React, { useRef, useState } from 'react';
import html2pdf from 'html2pdf.js';
import { ActionButtons, StatusBadge } from './IncidentButtons'; // Import the new components
import { ConfirmationModal } from './IncidentConfirmationModal'; // Import the ConfirmationModal

const ViewIncidentReportAdmin = () => {
      ...
      activities: [
        {
          ...
          images: ['https://placehold.co/150x100/007bff/ffffff?text=Image+1', 'https://placehold.co/150x100/28a745/ffffff?text=Image+2'],
        },
        {
      ...
      activities: [
        {
          ...
          images: ['https://placehold.co/150x100/ffc107/000000?text=Image+1'],
        },
        {
    ...
    },
    {
      ...
      activities: [
        ...
        },
        {
          ...
          images: ['https://placehold.co/150x100/dc3545/ffffff?text=Image+1', 'https://placehold.co/150x100/6c757d/ffffff?text=Image+2'],
        },
      ],
    },
    {
      ...
      activities: [
        ...
        },
        {
          ...
          images: ['https://placehold.co/150x100/17a2b8/ffffff?text=Image+1'],
        },
      ],
    },
    {
  ...
  return (
    <>
      {/* PageMeta removed as it's an external component not provided */}
...
export default ViewIncidentReportAdmin;
